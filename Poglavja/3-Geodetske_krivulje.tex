...
\end{align*}
od koder iz glavnega sistema enačb res dobimo %TODO kako?
\begin{equation*}
...
Oglejmo si Gramm-Schmidtov postopek, ki nadometi bazo $\left\{ r_u, r_v\right\}$ z bazo $\left\{ e_1, e_2 \right\} $. \begin{align*}
    e_1 &= a r_u   \\
    e_2 &= b r_u + c r_v.
\end{align*}
