...
TODO: Kaj sploh je premonosna ploskev?? Možna (nepreverjena) definicija je sledeča?? 
...
Ploskev $X$ je premonosna z vektorskim polje $a(u)$ vzdolž krivulje $\gamma(u)$, če za vsako krivuljo $\rho(u)$ v $X$ obstaja funkcija $f: [a,b] \to \mathbb{R}$, da velja \begin{equation*}
\rho(u) = \gamma(u) + f(u)a(u).
\end{equation*}
Verjetno se seveda da ta pogoj povedati drugače, torej da opišeš točke na $X$ z nekim predpisom, vendar si ne bi upal ugibati.
\end{definicija}
