...
\[ \ddot{\gamma} = \ddot{\gamma}_g + \ddot{\gamma}_n.\]
...
\[ n_{\gamma}(t) = \frac{r_u(u(t), v(t)) \times  r_v(u(t), v(t))}{\lvert\lvert r_u(u(t), v(t)) \rvert\rvert }.\]
...
\label{def_povprecna_ukrivljenost}
    ...
    \[ H(m) = \frac{1}{2} (\kappa_1(m) + \kappa_2(m) ).\]
\end{definicija}
