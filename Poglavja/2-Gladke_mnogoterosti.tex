...
v_1 \rangle & \dots & \langle v_1,v_n \rangle
\end{pmatrix}
...
vektor $\omega \in \mathbb{R}^2$ in naj bo $v = \left( D_{(u_0, v_0)r} \cdot w \right)$. Potrebujemo krivuljo $\gamma(t) : (-\varepsilon, \varepsilon) \to  X,
...
TODO s tem dokaz seveda še ni končan. S spremebo oznake neznane funkcije je to precej očitno. Ta dokaz bo treba popraviti. Treba je dokazati, da je lahko funkcija $k(u)$ poljubna, torej
da je lahko enaka $k(u) = \tilde{\kappa}(u)$.
\qed
...
\label{def_posploseni_lastni_problem}
 ...
 \end{equation*}  
  Če je $B = I$, potem dobimo običajni lastni problem \begin{equation*}
...
$b$ po predpisu za polinom $p$, dobimo natanko zvezo iz prejšnjega izreka. 
\end{opomba}
